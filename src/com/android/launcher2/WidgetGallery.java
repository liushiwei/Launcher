...
public class WidgetGallery extends AppWidgetProvider {
	private static final String TAG="WidgetGallery";
	private static final String PKG = "com.android.gallery3d";
	private static final String CLS = "com.android.gallery3d.app.Gallery";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.GALLERY";

	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
			int[] appWidgetIds) {
		super.onUpdate(context, appWidgetManager, appWidgetIds);
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.widget_gallery);
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetGallery.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetGallery.class),remoteViews);
		}else{
