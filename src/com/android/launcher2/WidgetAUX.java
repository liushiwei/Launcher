...
public class WidgetAUX extends AppWidgetProvider {
	private static final String TAG="WidgetAUX";
	private static final String PKG = "com.carit.auxplayer";
	private static final String CLS = "com.carit.auxplayer.AUXPlayer";	
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.AUX";

	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
			int[] appWidgetIds) {
		super.onUpdate(context, appWidgetManager, appWidgetIds);
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.widget_aux);
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetAUX.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetAUX.class),remoteViews);
		}else{
