...
public class WidgetDrivingMode extends AppWidgetProvider {
	private static final String TAG="WidgetDrivingMode";
	private static final String PKG = "com.carit.carlfweather";
	private static final String CLS = "com.carit.carlfweather.CompassActivity";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.DRIVINGMODE";

	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
			int[] appWidgetIds) {
		super.onUpdate(context, appWidgetManager, appWidgetIds);
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.widget_driving_mode);
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetDrivingMode.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetDrivingMode.class),remoteViews);
		}else{
