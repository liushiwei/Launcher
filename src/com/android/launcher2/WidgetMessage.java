...
public class WidgetMessage extends AppWidgetProvider {
	private static final String TAG = "WidgetMessage";
	private static final String PKG = "com.android.mms";
	private static final String CLS = "com.android.mms.ui.ConversationList";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.MESSAGE";
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetMessage.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetMessage.class),remoteViews);
		}else{
