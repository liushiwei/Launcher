...
public class WidgetMaxthon extends AppWidgetProvider {
	private static final String TAG="WidgetMaxthon";
	private static final String PKG = "com.mx.browser.tablet";
	private static final String CLS = "com.mx.browser.SplashActivity";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.MAXTHON";

	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
			int[] appWidgetIds) {
		super.onUpdate(context, appWidgetManager, appWidgetIds);
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.widget_maxthon);
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetMaxthon.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetMaxthon.class),remoteViews);
		}else{
