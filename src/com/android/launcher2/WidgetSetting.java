...
public class WidgetSetting extends AppWidgetProvider {
	private static final String TAG="SettingWidge";
	private static final String PKG = "com.android.settings";
	private static final String CLS = "com.android.settings.Settings";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.SETTING";

	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
			int[] appWidgetIds) {
		super.onUpdate(context, appWidgetManager, appWidgetIds);
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.widget_setting);
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetSetting.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetSetting.class),remoteViews);
		}else{
