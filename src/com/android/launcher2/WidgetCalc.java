...
public class WidgetCalc extends AppWidgetProvider {
	private static final String TAG="WidgetCalc";
	private static final String PKG = "com.android.calculator2";
	private static final String CLS = "com.android.calculator2.Calculator";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.CALC";
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetCalc.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetCalc.class),remoteViews);
		}else{
