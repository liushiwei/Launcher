...
public class WidgetEQ extends AppWidgetProvider {
	private static final String TAG="WidgetEQ";
	private static final String PKG = "com.carit.eqset";
	private static final String CLS = "com.carit.eqset.EQActivity";	
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.EQ";

	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
			int[] appWidgetIds) {
		super.onUpdate(context, appWidgetManager, appWidgetIds);
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.widget_eq);
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetEQ.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetEQ.class),remoteViews);
		}else{
