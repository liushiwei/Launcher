...
public class WidgetFileManager extends AppWidgetProvider {
	private static final String TAG="WidgetFileManager";
	private static final String PKG = "com.carit.filemanager";
	private static final String CLS = "com.carit.filemanager.FileManagerActivity";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.FILEMANAGER";

	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
			int[] appWidgetIds) {
		super.onUpdate(context, appWidgetManager, appWidgetIds);
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.widget_filemanager);
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetFileManager.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetFileManager.class),remoteViews);
		}else{
