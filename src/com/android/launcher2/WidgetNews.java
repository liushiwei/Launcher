...
public class WidgetNews extends AppWidgetProvider {
	...
	private static final String PKG = "com.android.caritinfo";
	private static final String CLS = "com.android.caritinfo.CaritInformationClientActivity";
	private static final String WIDGET_APP_ACTION="com.android.launcher.intent.action.NEWS";
	...
	void updateAppWidget(Context context,RemoteViews remoteViews,int[] appWidgetIds){
		...
		if(appWidgetIds == null){
			appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                context, WidgetNews.class));
		}
		
		if(appWidgetIds == null){
			appWidgetManager.updateAppWidget(new ComponentName(
					context,WidgetNews.class),remoteViews);
		}else{
